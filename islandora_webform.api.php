 ...
 * the content that appears on the the submissions tab for an islandora/fedora object.
 * The $element variable is passed by reference and may be modified by this hook.
 *
 * @param $element
